...
describe('Create tweet tests',()=>{
    test('should create a new tweet and return it', async()=>{
        ...
        const spy=jest.spyOn(Tweet,'create').mockImplementation(()=>{
            return {...data,createdAt:'2023-02-14', updatedAt:'2023-08-14'}
        })
...
describe('Get all tweets tests',()=>{
    test('testing limit for all',async()=>{
        const  data={
            content:'Testing tweet'
        }
        const tweetsArray=[{...data,createdAt:'2023-02-14', updatedAt:'2023-08-14'},{...data,createdAt:'2023-02-14', updatedAt:'2023-08-14'},{...data,createdAt:'2023-02-14', updatedAt:'2023-08-14'}]
